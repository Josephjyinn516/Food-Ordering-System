 ...
 * @author User
 */
public class Runner_Create extends javax.swing.JFrame {
...
//    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        String runnerName = jTextField1.getText();
        String email = jTextField2.getText();
        ...
        Runner newRunner = new Runner(runnerName, email, phoneNumberStr, password);
        ...
        Runner_FileHandling runnerFileHandler = new Runner_FileHandling();
        boolean dataSaved = runnerFileHandler.createRunnerData("Runner Profile.txt", newRunner);

        if (dataSaved) {
            JOptionPane.showMessageDialog(this, runnerName + " added successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
            jTextField1.setText("");
            jTextField2.setText("");
            jTextField3.setText("");
...
//                // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Runner_Create.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Runner_Create().setVisible(true);
            }
        });
    }

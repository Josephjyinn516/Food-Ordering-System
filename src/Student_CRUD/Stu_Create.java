 ...
 * @author User
 */
public class Stu_Create extends javax.swing.JFrame {
...
//    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        String schoolEmail = jTextField3.getText();
        ...
        if (studentName.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Student Name is required.", "Validation Error", JOptionPane.ERROR_MESSAGE);
            return; // Exit the method
        }
        ...
        if (schoolEmail.isEmpty()) {
            JOptionPane.showMessageDialog(this, "School Email is required.", "Validation Error", JOptionPane.ERROR_MESSAGE);
            return; // Exit the method
        }

        Student newStudent = new Student(studentID, studentName, schoolEmail, creditBalance, password);
        ...
        boolean dataSaved = stuFileHandler.createStudentData("Student Profile.txt", newStudent);

        if (dataSaved) {
            JOptionPane.showMessageDialog(this, studentName + " added successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
            jTextField1.setText("");
            jTextField2.setText("");
            jTextField3.setText("");
...
//                // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stu_Create.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Stu_Create().setVisible(true);
            }
        });
    }
